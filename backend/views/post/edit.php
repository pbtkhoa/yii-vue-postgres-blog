            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div id="editor-one" class="editor-wrapper"
                         data-input-target="#editor-content"><?= $model->content ?></div>
                    ...
                    <?= $form->field($model, 'categories')->checkboxList($listCheckBox, [
                        'item' => function ($index, $label, $name, $checked, $value) {
                            if ($checked) {
                                ...
                                return "<div class='checkbox'><label><input type='checkbox' class='flat' name='{$name}' value='{$value}'> {$label}</label></div>";
                            }
                        }
                    ])->label(false)
                    ?>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="img-post-thumbnail">
                        ...
                        <?php else: ?>
                            <button class="btn btn-primary hidden">Upload file</button>
                            <?= $form->field($model, 'thumbnail', ['template' => '{input}{error}'])->fileInput(['class' => 'hidden']) ?>
                            <img class="img-responsive" src="<?= $model->thumbnail ?>">
                        <?php endif; ?>
                    </div>
                </div>
            </div>
